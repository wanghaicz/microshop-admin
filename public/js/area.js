...
var s=["s_province","s_city","s_district"];//三个select的name
var opt0 = ["省(市)","市","区(县)"];//初始值
function _init_area(init_opt0){  //初始化函数
	if($.isArray(init_opt0) && init_opt0.length>0) opt0 = init_opt0;
